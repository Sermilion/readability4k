...
open class RegExUtil {
  ...
  open fun hasContent(matchString: String): Boolean = hasContent.containsMatchIn(matchString)

  open fun isWhitespace(matchString: String): Boolean = whitespace.containsMatchIn(matchString)
